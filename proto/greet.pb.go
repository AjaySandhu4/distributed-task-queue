...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\aGreeter\x125\n" +
	"\bSayHello\x12\x13.greet.HelloRequest\x1a\x14.greet.HelloResponse\x129\n" +
	"\fAskHowAreYou\x12\x13.greet.HelloRequest\x1a\x14.greet.HelloResponseB;Z9github.com/AjaySandhu4/distributed-task-queue/proto/greetb\x06proto3"
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	0, // 1: greet.Greeter.AskHowAreYou:input_type -> greet.HelloRequest
	1, // 2: greet.Greeter.SayHello:output_type -> greet.HelloResponse
	1, // 3: greet.Greeter.AskHowAreYou:output_type -> greet.HelloResponse
